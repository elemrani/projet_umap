...
console.log("conv")
   setValue(`${path}.config.filters`,getValue(`${path}.config.filters`))
    console.log(path)
    ...
    return (
     ...
     <ShapeInput setValue={setValue} getValue={getValue} path={`${path}.config.dilatation_rate`} /></div>
       ...
       <div className="form-group col-md-2">
        ...
        <div className="form-group col-md-2">
        <label >Filters:</label>
        <input {...register(`${path}.config.filters`)}  type="number"  /></div>
       
      <div className="form-group col-md-2">
        <label >Kernel_size:</label>
        <ShapeInput setValue={setValue} getValue={getValue} path={`${path}.config.kernel_size`} /></div>
        ...
        <label >Padding:</label>
          <select {...register(`${path}.config.padding`)}>
              ...
              <div className="form-group col-md-2">
                           <label >Strides:</label>
                            <ShapeInput setValue={setValue} getValue={getValue} path={`${path}.config.strides`} />{//placeholder="{this.state.pool_size}"
                             }
                           </div>
